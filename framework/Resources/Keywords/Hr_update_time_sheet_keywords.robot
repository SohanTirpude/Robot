...
Click Element If Present111
    ...
    Run Keyword If    '${element_present}' == 'False'    Execute JavaScript    arguments[0].click();    Get WebElement    ${locator}
